                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row mb-4 mb-4">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" readonly name="frequest" id="frequest" class="form-control" value="">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" readonly name="allocation" id="allocation" class="form-control" placeholder="244January2021">
