                                    ...
                                    @foreach ($departments as $department )
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap;width:20%;">
                                                ...
                                                <button type="button" class="d-inline btn-sm btn btn-success" data-toggle="modal" data-target="#showJobcard" data-department="{{ $department->name }}" data-manager="{{ $department->manager }}" ><i class="fa fa-eye"></i></button>
