                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="card_month" id="card_month" class="form-control" style="width: 100%;">
                                            ...
                                            <option value="August@php echo date('Y') @endphp">August@php echo date('Y') @endphp</option>
                                            <option value="September@php echo date('Y') @endphp">September@php echo date('Y') @endphp</option>
                                            <option value="October@php echo date('Y') @endphp">October@php echo date('Y') @endphp</option>
                                            <option value="November@php echo date('Y') @endphp">November@php echo date('Y') @endphp</option>
                                            <option value="December@php echo date('Y') @endphp">December@php echo date('Y') @endphp</option>
                                        </select>
                                    </div>
                                    @error('card_month')
                                        <span class="invalid-feedback" role="alert">
