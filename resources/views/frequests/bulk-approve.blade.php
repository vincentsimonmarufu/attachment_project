                                    ...
                                    <table class="table" style="border-top: none;">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" data-type="created_at" name="created_at[]" id="created_at_1" ></td></td>
                                                <td><input type="text" class="form-control" data-type="done_by" name="done_by[]" id="done_by_1" ></td></td>
                                                <td><input type="text" class="form-control" data-type="reqtype" name="reqtype[]" id="reqtype_1" ></td></td>
                                            </tr>
                                        </tbody>
                                    </table>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" language="javascript" >
        ...
        $(".addbtn").on('click',function(){
            ...
            data += '<td><input type="text" class="form-control" data-type="created_at" name="created_at[]" id="created_at_'+i+'" ></td></td>';
            data += '<td><input type="text" class="form-control" data-type="done_by" name="done_by[]" id="done_by_'+i+'" ></td></td>';
            data += '<td><input type="text" class="form-control" data-type="reqtype" name="reqtype[]" id="reqtype_'+i+'" ></td></td>';
            $('table').append(data);
            i++;
        });
        function select_all() {
