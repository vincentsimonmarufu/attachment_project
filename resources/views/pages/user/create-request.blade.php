            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('create-user-request') }}">Add New</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <h4 style="font-size:18px;">Create new humber request <span>
                                        ...
                                        <p class="pt-2">Please note that if request type is extra humber , allocation is
                                            not considered.</p>
                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    name="paynumber" value="{{ Auth::user()->paynumber }}" readonly
                                                    id="paynumber">
                                            </div>
